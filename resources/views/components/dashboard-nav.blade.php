    ...
    <ul class="nav flex-column w-100">
        ...
        <li class="nav-item">
            <a href="{{ route('caixas.index') }}"
               class="nav-link {{ request()->routeIs('caixas.*') ? 'active bg-purple-sidebar text-purple-active' : 'bg-white text-gray-sidebar' }} rounded-0 px-4 py-3 w-100 d-flex align-items-center group"
               style="{{ request()->routeIs('caixas.*') ? 'border-left: 4px solid #7212E7; color: #7212E7;' : '' }}">
                <i class="fas fa-profile me-3 group-hover:text-[#7212E7]" style="{{ request()->routeIs('caixas.*') ? 'color: #7212E7;' : '' }}"></i> 
                <span class="group-hover:text-[#7212E7]">
                    Caixas
                </span>
            </a>
        ...
        <li class="nav-item">
            <a href="{{ route('balcao') }}"
               class="nav-link {{ request()->routeIs('balcao') ? 'active bg-purple-sidebar text-purple-active' : 'bg-white text-gray-sidebar' }} rounded-0 px-4 py-3 w-100 d-flex align-items-center group"
               style="{{ request()->routeIs('balcao') ? 'border-left: 4px solid #7212E7; color: #7212E7;' : '' }}">
                <i class="fas fa-cash-register me-3 group-hover:text-[#7212E7]" style="{{ request()->routeIs('balcao') ? 'color: #7212E7;' : '' }}"></i> 
                <span class="group-hover:text-[#7212E7]">
                    Balcão
                </span>
            </a>
