...
@section('content')
    <x-layouts.breadcrumb title="Bairros" :breadcrumbs="[['name' => 'Bairros', 'route' => 'bairros.index']]">
        <a href="{{ route('bairros.create') }}" class="btn btn-purple-main text-white">Novo Bairro</a>
                ...
                @foreach ($bairros as $bairro)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('bairros.edit', $bairro->id) }}" class="btn btn-sm" style="color: #7212E7;" title="Editar">
                            ...
                            <a href="#" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#deleteBairroModal-{{ $bairro->id }}" style="color: #7212E7;" title="Visualizar">
                                <svg xmlns="http://www.w3.org/2000/svg" class="lucide" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7212E7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="modal fade" id="deleteBairroModal-{{ $bairro->id }}" tabindex="-1" aria-labelledby="deleteBairroModalLabel-{{ $bairro->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="deleteBairroModalLabel-{{ $bairro->id }}">Confirmar Exclusão</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
                                </div>
                                <div class="modal-body">
                                    Tem certeza que deseja excluir o bairro <strong>{{ $bairro->nome }}</strong>? Esta ação não poderá ser desfeita.
                                </div>
