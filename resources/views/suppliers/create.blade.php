...
@section('content')
    <x-layouts.breadcrumb title="Novo Fornecedor" :breadcrumbs="[
        ['name' => 'Fornecedores', 'route' => 'suppliers.index'],
        ['name' => 'Novo Fornecedor', 'route' => 'suppliers.create'],
    ]">
        ...
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <input type="phone" name="phone" id="phone"  value="{{ old('phone') }}" required class="form-control p-3 @error('phone') is-invalid @enderror"
                ...
                <div class="col-4">
                    ...
                    <input type="cnpj" name="cnpj" id="cnpj"  value="{{ old('cnpj') }}" required class="form-control p-3 @error('cnpj') is-invalid @enderror"
