            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" name="name" id="name" required
                        ...
                        placeholder="Digite o nome do funcionário..." value="{{ old('name', $employees->name) }}">
                    @error('name')
                ...
                <div class="col-6">
                    ...
                    <input type="email" name="email" id="email"
                        ...
                        placeholder="Digite o email do funcionário..." value="{{ old('email', $employees->email) }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="phone" name="phone" id="phone" required class="form-control p-3"
                        placeholder="Digite o telefone do funcionário..." value="{{ old('phone', $employees->phone) }}">
                </div>
                <div class="col-6">
                    ...
                    <div class="position-relative" style="position: relative;">
                        @php
                            $selectedRoleId = old('role_id', $employees->user->role->id ?? null);
                        @endphp
                        <select name="role_id" id="role_id" class="form-control p-3"
                            ...
                            @foreach ($roles as $role)
                                ...
                                @endphp
                                <option value="{{ $role->id }}" data-role-code="{{ $roleCode }}"
